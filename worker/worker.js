...
"- Write in PLAIN TEXT only. NEVER use markdown or formatting symbols — no asterisks, no **bold**, no # headings, no tables, no bullet stars. Do NOT structure every answer as a numbered list with bold labels; that reads like an AI. Prefer natural, flowing sentences, and use a short simple list only when it genuinely helps.",
